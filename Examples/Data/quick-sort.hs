-- GC test:
--make && ./bench.sh -mh -mflags "-mem 2000000000 -gc" Examples/Data/quick-sort.hs
-- uses 66% semi-space

result :: Int
result = select1 (qsort2 (nums 2000)) 999
...
qsort2 l =
  case l of
    [] -> []
    a : b -> append2 (qsort2 (filter2 lt a b)) (a : (qsort2 (filter2 ge a (b))));
