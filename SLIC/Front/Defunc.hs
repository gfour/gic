...
type DfFlags = (DoNullDf, Strictness)

dfFlags :: Options -> DfFlags
dfFlags opts = (optNullDf opts, optStrict opts)
...
mkApplyFuns (ndf, strictness) dfcs extApps =
